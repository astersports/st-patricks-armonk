...
import { BookOpen, GraduationCap, Phone, Calendar, Users } from "lucide-react";
    ...
    <PageLayout>
      <section className="bg-gradient-to-b from-primary/5 to-transparent py-16">
        <div className="container">
          <h1 className="font-serif text-4xl md:text-5xl font-bold text-foreground mb-3">Faith Formation</h1>
          ...
          <div className="space-y-6">
            <Card className="bg-primary text-white">
              <CardContent className="p-6">
                ...
                <p className="font-bold text-lg">(914) 531-1759</p>
              </CardContent>
            </Card>
