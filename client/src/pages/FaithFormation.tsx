          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 sm:gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <Accordion type="single" collapsible className="space-y-2.5">
                ...
                <AccordionItem
                  value="ccd"
                  className="reveal border border-border/50 rounded-xl overflow-hidden shadow-[0_1px_3px_rgba(0,0,0,0.04)] transition-all hover:shadow-[0_2px_8px_rgba(0,0,0,0.06)] border-l-3 border-l-[oklch(0.42_0.12_141)]"
                >
