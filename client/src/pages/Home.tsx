...
// === THIS SUNDAY PREVIEW — Shows next Sunday's readings & Mass info ===
function ThisSundayPreview() {
  ...
  // Don't show if Sunday is more than 6 days away (shouldn't happen, but safety)
      ...
      <CardContent className="p-0">
        <Link href="/mass-times" className="block group">
          <div className="px-4 py-3">
            ...
            {/* Readings summary — compact pills */}
