...
const sacraments = [
  {
    ...
    accent: "border-l-[oklch(0.44_0.12_160)]",
    badge: null,
    content: (
      <>
        ...
        <section className="py-6 sm:py-10">
          <div className="container max-w-4xl">
            ...
            <div className="mt-10 grid md:grid-cols-2 gap-4">
              <Card className="p-5 border border-border/50 border-l-3 border-l-[oklch(0.44_0.12_160)] shadow-[0_1px_3px_rgba(0,0,0,0.04)] transition-all hover:shadow-[0_2px_8px_rgba(0,0,0,0.06)] rounded-xl">
